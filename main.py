...
async def introduce_speaker(state: State):
    ...
    chain = prompt | llm
    speaker_introduction = chain.invoke({"speaker_name": current_speaker_data.speaker_name, "speaker_designation": current_speaker_data.designation, "speaker_inspiration": current_speaker_data.inspiration, "purpose_of_speech": current_speaker_data.purpose_of_speech, "script_of_speech": current_speaker_data.script_of_speech})
    ...
    try:
        ...
        logger.error(f"Some error occured in introduce speaker: {e}")
                ...
                if data["type"] == "websocket.receive" and "text" in data:
                    ...
                    if data:
                        if not data["speakerAvailable"]:
                            ...
                            print(f"Response generated after speaker stopped speaking or bcuz of speaker's unavailibility", response)
